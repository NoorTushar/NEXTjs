...
const BlogsPage = () => {
   return (
      <div>
         <h2 className="text-center text-2xl">This is the blogs page.</h2>
         <button className="my-btn my-6">
            <Link href={"/blogs/specialBlogs"}>Special Blogs</Link>
         </button>
         <div className="grid grid-cols-3 gap-6">
            {blogs.map((blog) => (
               <div
                  className="p-6 bg-gray-800 flex flex-col gap-4"
                  key={blog.id}
               >
